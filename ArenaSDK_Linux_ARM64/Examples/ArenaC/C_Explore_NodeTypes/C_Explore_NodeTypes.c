...
AC_ERROR ExploreBoolean(acNodeMap hNodeMap, acNode hNode, const char* nodeName)
{
	...
	// Set value
	//{
		// bool8_t boolValue = true; err = acBooleanSetValue(hNode, boolValue);
...
AC_ERROR ExploreString(acNode hNode)
{
	...
	// Set value
	//{
		// char stringValue[MAX_BUF] = "string value"; err =
		// acStringSetValue(hNode, stringValue); if (err != AC_ERR_SUCCESS)
		// return err;
	//}
...
AC_ERROR ExploreEnumeration(acNode hNode, const char* nodeName)
{
	...
	//{
		// acNode hEnumerationEntryNode = NULL; err =
		// acEnumerationGetEntryByName(hEntryNode, nodeName,
		// &hEnumerationEntryNode); if (err != AC_ERR_SUCCESS) return err;
	//}

	// Set value
	//{
		// int64_t intValue = 0; err = acEnumerationSetByIntValue(hNode,
		// intValue); if (err != AC_ERR_SUCCESS) return err;
	//}
...
AC_ERROR ExploreInteger(acNode hNode)
{
	...
	printf("%sMinimum, maximum: %" PRId64 ", %" PRId64 "\n", TAB3, pMinimum, pMaximum);
	...
	//{
		// int64_t imposedMinimum = 0; int64_t imposedMaximum = 10; err =
		// acIntegerImposeMin(hNode, imposedMinimum); if (err != AC_ERR_SUCCESS)
		// return err;
	//
		// err = acIntegerImposeMax(hNode, imposedMaximum); if (err !=
		// AC_ERR_SUCCESS) return err;
	//}

	// Set value
	//{
		// int64_t intValue = 0; err = acIntegerSetValue(hNode, intValue); if
		// (err != AC_ERR_SUCCESS) return err;
	//}
...
AC_ERROR ExploreFloat(acNodeMap hNode)
{
	...
	printf("%sMinimum, maximum: %.0lf, %.0lf \n", TAB3, minimum, maximum);
	...
	// Impose maximum and minimum
	//{
		// double imposedMinimum = 0; double imposedMaximum = 10;

		// err = acFloatImposeMin(hNode, imposedMinimum); if (err !=
		// AC_ERR_SUCCESS) return err;

		// err = acFloatImposeMax(hNode, imposedMaximum); if (err !=
		// AC_ERR_SUCCESS) return err;
	//}

	// Set value
	//{
		// double floatValue = 0; err = acFloatSetValue(hNode, floatValue); if
		// (err != AC_ERR_SUCCESS) return err;
	//}
