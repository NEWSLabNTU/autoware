...
//    Windows system allocates a total of 2GB of memory for all data types. LUCID
//    recommends that you run this example on an x64 platform, which has an 8TB
//    memory limit: 2GB of shared data between the stack and static data, and the
...
// (1) ensures increment
// (2) ensures value is over minimum
// (3) ensures value is below maximum
// (4) sets value
...
// (1) ensures value is over minimum
// (2) ensures value is below maximum
// (3) sets value
