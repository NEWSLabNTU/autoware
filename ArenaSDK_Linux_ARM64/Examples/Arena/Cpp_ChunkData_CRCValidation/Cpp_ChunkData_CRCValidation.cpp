...
void ConfigureAndValidateCRC(Arena::IDevice* pDevice)
{
	...
	//    incomplete, the CRCs will not match. Attempting to verify
	//    the CRC on an incomplete image will throw an exception.
	...
	// Compare CRCs
	//    Compare CRCs to verify whether the data is correct. The data can be assumed 
	//    to be valid and correct only if the CRC and the chunk CRC match.
